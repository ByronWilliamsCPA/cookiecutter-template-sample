...
def main():
    ...
    parser.add_argument(
        "--project-key",
        default="yourusername_my_python_project",
        help="SonarQube project key (default: yourusername_my_python_project)"
    )
    parser.add_argument(
        "--token",
    ...
    parser.add_argument(
        "--org",
        default=os.environ.get("SONAR_ORG", "yourusername"),
        help="SonarQube organization (default: yourusername)"
    )
    parser.add_argument(
        "--rad-tags",
        type=int,
