...
class TestPackageInitialization:
    ...
    def test_package_author_exists(self) -> None:
        ...
        """
        from my_python_project import __author__, __email__
...
class TestLogging:
    ...
    def test_log_performance(self) -> None:
        ...
        from my_python_project.utils.logging import log_performance
...
class TestExampleIntegration:
    ...
    def test_package_imports(self) -> None:
        ...
        assert hasattr(my_python_project, "__version__")

        # Test importing from submodules
        from my_python_project.utils import get_logger

        assert callable(get_logger)

        from my_python_project.core import Settings
