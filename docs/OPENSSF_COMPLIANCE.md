...
wget https://github.com/yourusername/my_python_project/releases/download/v1.0.0/package.whl
wget https://github.com/yourusername/my_python_project/releases/download/v1.0.0/package.whl.sig
wget https://github.com/yourusername/my_python_project/releases/download/v1.0.0/package.whl.pem

# Verify signature
cosign verify-blob \
  --certificate package.whl.pem \
  --signature package.whl.sig \
  --certificate-identity-regexp="https://github.com/yourusername/my_python_project" \
...
wget https://github.com/yourusername/my_python_project/releases/download/v1.0.0/attestation.intoto.jsonl

# Verify with slsa-verifier
slsa-verifier verify-artifact package.whl \
  --provenance-path attestation.intoto.jsonl \
  --source-uri github.com/yourusername/my_python_project
```
...
1. Go to: `https://github.com/yourusername/my_python_project/settings/branches`
...
**Security Questions**: you@example.com
**Vulnerability Reports**: See [Security Policy](https://github.com/yourusername/.github/blob/main/SECURITY.md)
**General Issues**: [GitHub Issues](https://github.com/yourusername/my_python_project/issues)
