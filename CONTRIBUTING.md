...
Thank you for your interest in contributing to My Python Project! This document provides guidelines and instructions for contributing to the project.
...
This project adheres to the [yourusername organization Code of Conduct](https://github.com/yourusername/.github/blob/main/CODE_OF_CONDUCT.md). By participating, you are expected to uphold this code. Please report unacceptable behavior to you@example.com.
...
- **Coverage**: Must maintain ≥60% overall coverage
...
- **Overall Coverage**: 60% minimum (enforced by CI)
...
import pytest
from pathlib import Path
from my_python_project.core import YourModule
...
- [ ] Code coverage meets minimum requirements (60%)
...
- **General Questions**: Open a [GitHub Discussion](https://github.com/yourusername/my_python_project/discussions)
- **Bug Reports**: Open a [GitHub Issue](https://github.com/yourusername/my_python_project/issues)
- **Security Issues**: See [yourusername Security Policy](https://github.com/yourusername/.github/blob/main/SECURITY.md)
